...
class ConllXPOSDatasetReader(TaggingDatasetReader):
    """
    Reads a file in the CoNLL-X format and returns instances suitable for POS tagging.
    ...
    def _read_dataset(self,
        ...
        with open(file_path) as tagging_file:
            ...
            for i in ids:
                ...
                if learn_vocab:
                    yield [x["pos"] for x in annotation]
                else:
